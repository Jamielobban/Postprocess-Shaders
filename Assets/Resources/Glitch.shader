Shader "Custom/Glitch"
{
    Properties
    {
        ...
        _LineJitterAmp     ("Line Jitter Amplitude (px)", Range(0,64)) = 6
    ...
    SubShader
    {
        ...
        Pass
        {
           ...
           CBUFFER_START(UnityPerMaterial)
            float4 _Tint;
            float  _GlitchAmount, _LineJitterProb, _LineJitterAmp;
            float  _BlockProb, _BlockSize, _BlockShift;
            float  _RowProb, _RowHeight, _RowChangeRate;
            float  _ChromaAmount, _ScanlineAmount, _ScanlineDensity;
            float  _StutterProb, _StutterStrength;
            CBUFFER_END
            // Hash helpers
